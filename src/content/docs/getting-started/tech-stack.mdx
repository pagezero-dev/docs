...
🛤️ **[TanStack Start](https://tanstack.com/start)** - provides the full-stack framework layer. Built on TanStack Router, it adds server-side rendering, type-safe server functions (`createServerFn`), and type-safe routing.
