...
<LinkButton href="http://localhost:6006/?path=/story/apps-brand-testimonials--default" variant="secondary" icon="external">Storybook</LinkButton>

## Import

```js
import { Testimonials } from '@/brand/components/testimonials'
```
