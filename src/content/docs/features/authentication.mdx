...
3. **Add `BETTER_AUTH_URL`** - set this to your app's public URL for each environment (for example `https://your-app.workers.dev` or your custom domain):

   ```sh
   bunx wrangler secret put BETTER_AUTH_URL --env=preview
   ```
